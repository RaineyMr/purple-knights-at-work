-- Purple Knights at Work - Corrected Demo Data
-- All-male, all-Black high school profiles
...
-- ===================================================================
-- STEP 3: INSERT PROFILES (replace UUIDs below)
...
-- ===================================================================
-- STEP 4: INSERT SKILLS (update profile_ids with actual UUIDs)
...
-- ===================================================================
-- STEP 5: INSERT EXPERIENCE (update profile_ids with actual UUIDs)
...
-- ===================================================================
-- STEP 6: INSERT EDUCATION (update profile_ids with actual UUIDs)
...
-- ===================================================================
-- STEP 7: INSERT PREFERENCES (update profile_ids with actual UUIDs)
...
-- ===================================================================
-- STEP 8: INSERT JOB POSTINGS (update employer_ids with actual UUIDs)
...
'Tech Innovations is seeking a talented Frontend Developer to join our growing development team in New Orleans. As a Frontend Developer, you will be responsible for building responsive, user-friendly web applications using React, TypeScript, and modern web technologies. We are specifically looking for St. Augustine High School alumni who share our commitment to excellence and brotherhood.
...
-- Job 2: Marketing Manager at Gulf Marketing Group
INSERT INTO job_postings (employer_id, title, description, job_type, industry, location, remote_option, salary_min, salary_max, salary_currency, required_skills, preferred_skills, experience_level, alumni_preferred, status, posted_date, deadline) VALUES
('UUID_HERE', 'Marketing Manager', 
...
-- ===================================================================
-- STEP 9: INSERT APPLICATIONS (update profile_ids and employer_ids with actual UUIDs)
...
-- ===================================================================
-- STEP 12: INSERT MENTORSHIP RELATIONSHIPS
...
-- ===================================================================
-- STEP 14: INSERT CAREER MILESTONES
...
-- ===================================================================
-- STEP 16: INSERT PLATFORM METRICS
