-- Purple Knights at Work - Simple Demo Setup
-- No UUID handling required - just run in sections

-- ===================================================================
-- SECTION 1: CREATE AUTH USERS FIRST
-- Go to Supabase Authentication → Users and create these accounts:
-- All passwords: PurpleKnights2024

-- Alumni Accounts:
-- marcus.thompson@purpleknights.work
-- samantha.rodriguez@purpleknights.work  
-- robert.johnson@purpleknights.work
-- patricia.brown@purpleknights.work
-- james.miller@purpleknights.work

-- Employer Accounts:
-- tech.innovations@purpleknights.work
-- gulf.marketing@purpleknights.work
-- financial.services@purpleknights.work
-- healthcare.plus@purpleknights.work
-- education.first@purpleknights.work

-- Admin Account:
-- admin@purpleknights.work

-- ===================================================================
-- SECTION 2: GET USER UUIDS
-- After creating users, run this to get their UUIDs:
...
-- ===================================================================
-- SECTION 3: INSERT PROFILES (replace UUIDs below)
-- Copy the UUIDs from the query above and replace the placeholders

-- Marcus Thompson (replace with actual UUID)
...
-- Tech Innovations (replace with actual UUID)
...
('UUID_HERE', 'Tech', 'Innovations', 'employer', 'Tech Innovations', 'Technology', '50-100', 'https://techinnovations.com', 'https://via.placeholder.com/150x150/6B46C1/FFFFFF?text=TI', 'New Orleans, LA', NULL);

-- Gulf Marketing Group (replace with actual UUID)
INSERT INTO profiles (id, first_name, last_name, role, company_name, industry, company_size, website, logo_url, location, allow_employer_contact) VALUES
('UUID_HERE', 'Gulf', 'Marketing', 'employer', 'Gulf Marketing Group', 'Marketing & Advertising', '25-50', 'https://gulfmarketing.com', 'https://via.placeholder.com/150x150/F59E0B/FFFFFF?text=GM', 'New Orleans, LA', NULL);

-- Financial Services LLC (replace with actual UUID)
INSERT INTO profiles (id, first_name, last_name, role, company_name, industry, company_size, website, logo_url, location, allow_employer_contact) VALUES
('UUID_HERE', 'Financial', 'Services', 'employer', 'Financial Services LLC', 'Finance & Banking', '100-250', 'https://financialservicesllc.com', 'https://via.placeholder.com/150x150/6B46C1/FFFFFF?text=FS', 'New Orleans, LA', NULL);

-- Healthcare Plus (replace with actual UUID)
INSERT INTO profiles (id, first_name, last_name, role, company_name, industry, company_size, website, logo_url, location, allow_employer_contact) VALUES
('UUID_HERE', 'Healthcare', 'Plus', 'employer', 'Healthcare Plus', 'Healthcare', '200-500', 'https://healthcareplus.com', 'https://via.placeholder.com/150x150/10B981/FFFFFF?text=HP', 'New Orleans, LA', NULL);

-- Education First (replace with actual UUID)
INSERT INTO profiles (id, first_name, last_name, role, company_name, industry, company_size, website, logo_url, location, allow_employer_contact) VALUES
('UUID_HERE', 'Education', 'First', 'employer', 'Education First', 'Education', '50-100', 'https://educationfirst.com', 'https://via.placeholder.com/150x150/8B5CF6/FFFFFF?text=EF', 'New Orleans, LA', NULL);

-- ===================================================================
-- SECTION 4: INSERT SKILLS (update profile_ids with actual UUIDs)

-- Marcus Skills (update profile_id with actual UUID)
...
-- Samantha Skills (update profile_id with actual UUID)
INSERT INTO alumni_skills (profile_id, skill_name, category, proficiency_level, endorsement_count) VALUES
...
-- Robert Skills (update profile_id with actual UUID)
INSERT INTO alumni_skills (profile_id, skill_name, category, proficiency_level, endorsement_count) VALUES
...
-- Patricia Skills (update profile_id with actual UUID)
INSERT INTO alumni_skills (profile_id, skill_name, category, proficiency_level, endorsement_count) VALUES
...
-- James Skills (update profile_id with actual UUID)
INSERT INTO alumni_skills (profile_id, skill_name, category, proficiency_level, endorsement_count) VALUES
...
-- ===================================================================
-- SECTION 5: INSERT EXPERIENCE (update profile_ids with actual UUIDs)
...
-- Samantha Experience
INSERT INTO alumni_experience (profile_id, company_name, position, start_date, end_date, current_position, description, location, industry) VALUES
('UUID_HERE', 'Current Marketing Agency', 'Marketing Manager', '2020-03-01', NULL, true, 'Lead team of 5 marketing specialists, manage $2.5M annual budget, develop integrated campaigns for Fortune 500 clients, increased client ROI by 35% through data-driven strategies, and mentor junior team members.', 'New Orleans, LA', 'Marketing'),
...
-- ===================================================================
-- SECTION 6: INSERT EDUCATION (update profile_ids with actual UUIDs)
...
-- ===================================================================
-- SECTION 7: INSERT JOB POSTINGS (update employer_ids with actual UUIDs)

-- Job 1: Frontend Developer at Tech Innovations
INSERT INTO job_postings (employer_id, title, description, job_type, industry, location, remote_option, salary_min, salary_max, salary_currency, required_skills, preferred_skills, experience_level, alumni_preferred, status, posted_date, deadline) VALUES
('UUID_HERE', 'Frontend Developer', 
...
-- Job 2: Digital Marketing Specialist at Gulf Marketing Group
INSERT INTO job_postings (employer_id, title, description, job_type, industry, location, remote_option, salary_min, salary_max, salary_currency, required_skills, preferred_skills, experience_level, alumni_preferred, status, posted_date, deadline) VALUES
('UUID_HERE', 'Digital Marketing Specialist', 
...
INSERT INTO job_postings (employer_id, title, description, job_type, industry, location, remote_option, salary_min, salary_max, salary_currency, required_skills, preferred_skills, experience_level, alumni_preferred, status, posted_date, deadline) VALUES
('UUID_HERE', 'Healthcare Administrator', 
...
INSERT INTO job_postings (employer_id, title, description, job_type, industry, location, remote_option, salary_min, salary_max, salary_currency, required_skills, preferred_skills, experience_level, alumni_preferred, status, posted_date, deadline) VALUES
('UUID_HERE', 'Education Program Manager', 
...
-- ===================================================================
-- SECTION 8: INSERT APPLICATIONS (update profile_ids and employer_ids with actual UUIDs)
...
(2, 70000, 'USD', 'Digital Marketing Specialist', '2024-02-15', '2024-01-30', 'pending', 'Above market rate with performance bonuses and team leadership opportunities.'),
...
-- ===================================================================
-- SECTION 11: INSERT MENTORSHIP RELATIONSHIPS
...
-- ===================================================================
-- SECTION 13: INSERT CAREER MILESTONES
...
('UUID_HERE', 'first_application', '{"job_title": "Digital Marketing Specialist", "company": "Gulf Marketing Group", "date": "2024-01-09"}'),
('UUID_HERE', 'first_interview', '{"job_title": "Digital Marketing Specialist", "company": "Gulf Marketing Group", "date": "2024-01-18", "interview_type": "in_person"}'),
('UUID_HERE', 'first_offer', '{"job_title": "Digital Marketing Specialist", "company": "Gulf Marketing Group", "salary": 70000, "date": "2024-01-28"}'),
...
-- ===================================================================
-- SECTION 14: INSERT NOTIFICATIONS
...
('UUID_HERE', 'Application Update', 'Your application for Digital Marketing Specialist is being reviewed by Gulf Marketing Group.', 'application_update', '{"application_id": 4, "status": "reviewing"}', false),
('UUID_HERE', 'Interview Scheduled', 'Gulf Marketing Group has scheduled an interview for the Digital Marketing Specialist position.', 'application_update', '{"application_id": 4, "status": "interview_scheduled"}', false),
('UUID_HERE', 'Job Offer Received', 'Gulf Marketing Group has extended an offer for the Digital Marketing Specialist position!', 'application_update', '{"application_id": 4, "status": "offer_extended", "salary": 70000}', false),
...
-- ===================================================================
-- SECTION 15: INSERT PLATFORM METRICS
...
('total_employers', 5, CURRENT_DATE, '{"active": 5, "alumni_friendly": 5, "hiring": 5}'),
