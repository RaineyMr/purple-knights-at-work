-- Purple Knights at Work - Updated Demo Data
...
('UUID_HERE', 'company-tech-innovations', 'Frontend Developer', '2024-02-01', NULL, true, true);

-- Andre Washington - Works at Gulf Marketing Group (can post jobs)
INSERT INTO company_affiliations (user_id, company_id, position, start_date, end_date, current_position, can_post_jobs) VALUES
('UUID_HERE', 'company-gulf-marketing', 'Marketing Manager', '2020-03-01', NULL, true, true);

-- Robert Johnson - Founder of his own company (can post jobs)
INSERT INTO company_affiliations (user_id, company_id, position, start_date, end_date, current_position, can_post_jobs) VALUES
('UUID_HERE', 'company-tech-innovations', 'Technical Advisor', '2024-02-01', NULL, true, true);

-- Michael Williams - Works at a tech company (can post jobs)
INSERT INTO company_affiliations (user_id, company_id, position, start_date, end_date, current_position, can_post_jobs) VALUES
('UUID_HERE', 'company-tech-innovations', 'VP of Engineering', '2018-01-01', NULL, true, true);

-- James Miller - Works at a law firm (can post jobs)
INSERT INTO company_affiliations (user_id, company_id, position, start_date, end_date, current_position, can_post_jobs) VALUES
('UUID_HERE', 'company-financial-services', 'Legal Advisor', '2009-01-01', NULL, true, true);
...
('company-tech-innovations', 'UUID_HERE', 'Frontend Developer', 
...
INSERT INTO job_postings (company_id, posted_by_user_id, title, description, job_type, industry, location, remote_option, salary_min, salary_max, salary_currency, required_skills, preferred_skills, experience_level, alumni_preferred, status, posted_date, deadline) VALUES
('company-gulf-marketing', 'UUID_HERE', 'Marketing Manager', 
...
INSERT INTO job_postings (company_id, posted_by_user_id, title, description, job_type, industry, location, remote_option, salary_min, salary_max, salary_currency, required_skills, preferred_skills, experience_level, alumni_preferred, status, posted_date, deadline) VALUES
('company-financial-services', 'UUID_HERE', 'Financial Analyst', 
...
INSERT INTO job_postings (company_id, posted_by_user_id, title, description, job_type, industry, location, remote_option, salary_min, salary_max, salary_currency, required_skills, preferred_skills, experience_level, alumni_preferred, status, posted_date, deadline) VALUES
('company-healthcare-plus', 'UUID_HERE', 'Healthcare Administrator', 
...
INSERT INTO job_postings (company_id, posted_by_user_id, title, description, job_type, industry, location, remote_option, salary_min, salary_max, salary_currency, required_skills, preferred_skills, experience_level, alumni_preferred, status, posted_date, deadline) VALUES
('company-education-first', 'UUID_HERE', 'Education Program Manager', 
